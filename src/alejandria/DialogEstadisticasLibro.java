 ...
 * @author Fran1488
 */
public class DialogEstadisticasLibro extends JDialog {

    ActionListener actionListener;

    public DialogEstadisticasLibro(JFrame parent, int id, String titulo) {
        ...
        JLabel datos = new JLabel("<html> <body style='background-color: #6088A2; color: #13233D; font-size: 1.2em; margin: 10px;'>"
                + " <p>Páginas leídas  : " + database.getTotalPages(id) + "</p>"
                + " <p>Tiempo total    : " + database.getTotalTime(id) + "</p>"
                + " </body> </html>");
